...
public class addSubjectToTeacherWindow {
    public static void addSubjectToTeacherPage() {
        JFrame frame = new JFrame("Add Subject To Teacher");
        ...
        AddSubject.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(isTeacherIdNum && isSubjectIdNum){
                    ...
                    int isAdded = Admin.addSubjectToTEacher(tID,sID);
                    if(isAdded == 1){
                        frame.setVisible(false);
                        JOptionPane.showMessageDialog(frame, "Subject Added To Teacher Successfull", "Subject Assigned", JOptionPane.INFORMATION_MESSAGE);
                    }else{
